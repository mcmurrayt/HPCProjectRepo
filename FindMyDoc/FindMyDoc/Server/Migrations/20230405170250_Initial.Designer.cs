...
namespace FindMyDoc.Server.Migrations
{
    ...
    [Migration("20230405170250_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FindMyDoc.Server.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("FindMyDoc.Shared.Provider", b =>
                {
                    ...
                    b.Property<int>("all_nurse_practitioners")
                        .HasColumnType("int");

                    b.Property<int>("all_physician_assistants")
                        .HasColumnType("int");

                    b.Property<int>("all_physicians")
                        .HasColumnType("int");

                    b.Property<int>("all_primary_care_nurse_practitioners")
                        .HasColumnType("int");

                    b.Property<int>("all_primary_care_physician_assistants")
                        .HasColumnType("int");

                    b.Property<int>("all_primary_care_physicians")
                        .HasColumnType("int");

                    b.Property<int>("all_primary_care_providers")
                        .HasColumnType("int");

                    b.Property<int>("all_providers")
                        .HasColumnType("int");

                    b.Property<string>("county_fips")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FindMyDoc.Server.Models.ApplicationUser", null)
                        .WithMany()
